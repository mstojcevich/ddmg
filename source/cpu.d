...
class CPU {
    ...
    @safe this(ref MMU mmu, ref Clock clk) {
        ...
        this.instructions = [
            Instruction("NOP",          1, 4, &nop),
            Instruction("LD BC,d16",    3, 12, {loadImmediate(regs.bc);}),
            Instruction("LD (BC),A",    1, 8, {storeInMemory(regs.bc, regs.a);}),
            Instruction("INC BC",       1, 8, {inc(regs.bc);}),
            Instruction("INC B",        1, 4, {inc(regs.b);}),
            Instruction("DEC B",        1, 4, {dec(regs.b);}),
            Instruction("LD B,d8",      2, 8, {loadImmediate(regs.b);}),
            Instruction("RLCA",         1, 4, &rlca),
            Instruction("LD (a16),SP",  3, 20, {storeInImmediateReference(regs.sp);}),
            Instruction("ADD HL,BC",    1, 8, {add(regs.hl, regs.bc);}),
            Instruction("LD A,(BC)",    1, 8, {loadFromMemory(regs.a, regs.bc);}),
            Instruction("DEC BC",       1, 8, {dec(regs.bc);}),
            Instruction("INC C",        1, 4, {inc(regs.c);}),
            Instruction("DEC C",        1, 4, {dec(regs.c);}),
            Instruction("LD C,d8",      2, 8, {loadImmediate(regs.c);}),
            Instruction("RRCA",         1, 4, &rrca),
            Instruction("STOP 0",       2, 4, null),
            Instruction("LD DE,d16",    3, 12, {loadImmediate(regs.de);}),
            Instruction("LD (DE),A",	1, 8, {storeInMemory(regs.de, regs.a);}),
            Instruction("INC DE",		1, 8, {inc(regs.de);}),
            Instruction("INC D",		1, 4, {inc(regs.d);}),
            Instruction("DEC D",		1, 4, {dec(regs.d);}),
            Instruction("LD D,d8",		2, 8, {loadImmediate(regs.d);}),
            Instruction("RLA",		    1, 4, &rla),
            Instruction("JR r8",		2, 12, &jumpRelativeImmediate),
            Instruction("ADD HL,DE",	1, 8, {add(regs.hl, regs.de);}),
            Instruction("LD A,(DE)",	1, 8, {loadFromMemory(regs.a, regs.de);}),
            Instruction("DEC DE",		1, 8, {dec(regs.de);}),
            Instruction("INC E",		1, 4, {inc(regs.e);}),
            Instruction("DEC E",		1, 4, {dec(regs.e);}),
            Instruction("LD E,d8",		2, 8, {loadImmediate(regs.e);}),
            Instruction("RRA",		    1, 4, &rra),
            Instruction("JR NZ,r8",		2, 0, &jumpRelativeImmediateNZ),
            Instruction("LD HL,d16",	3, 12, {loadImmediate(regs.hl);}),
            Instruction("LD (HL+),A",	1, 8, &storeAInMemoryHLPlus),
            Instruction("INC HL",		1, 8, {inc(regs.hl);}),
            Instruction("INC H",		1, 4, {inc(regs.h);}),
            Instruction("DEC H",		1, 4, {dec(regs.h);}),
            Instruction("LD H,d8",		2, 8, {loadImmediate(regs.h);}),
            Instruction("DAA",		    1, 4, null),
            Instruction("JR Z,r8",		2, 0, &jumpRelativeImmediateZ),
            Instruction("ADD HL,HL",	1, 8, {add(regs.hl, regs.hl);}),
            Instruction("LD A,(HL+)",	1, 8, {loadReferencePlus(regs.a);}),
            Instruction("DEC HL",		1, 8, {dec(regs.hl);}),
            Instruction("INC L",		1, 4, {inc(regs.l);}),
            Instruction("DEC L",		1, 4, {dec(regs.l);}),
            Instruction("LD L,d8",		2, 8, {loadImmediate(regs.l);}),
            Instruction("CPL",		    1, 4, {complement(regs.a);}),
            Instruction("JR NC,r8",		2, 0, &jumpRelativeImmediateNC),
            Instruction("LD SP,d16",	3, 12, {loadImmediate(regs.sp);}),
            Instruction("LD (HL-),A",	1, 8, &storeAInMemoryHLMinus),
            Instruction("INC SP",		1, 8, {inc(regs.sp);}),
            Instruction("INC (HL)",		1, 12, &incReference),
            Instruction("DEC (HL)",		1, 1, &decReference),
            Instruction("LD (HL),d8",	2, 12, {storeImmediateInMemory(regs.hl);}),
            Instruction("SCF",		    1, 4, {setFlag(Flag.OVERFLOW, true);}),
            Instruction("JR C,r8",		2, 0, &jumpRelativeImmediateC),
            Instruction("ADD HL,SP",	1, 8, {add(regs.hl, regs.sp);}),
            Instruction("LD A,(HL-)",	1, 8, {loadReferenceMinus(regs.a);}),
            Instruction("DEC SP",		1, 8, {dec(regs.sp);}),
            Instruction("INC A",		1, 4, {inc(regs.a);}),
            Instruction("DEC A",		1, 4, {dec(regs.a);}),
            Instruction("LD A,d8",		2, 8, {loadImmediate(regs.a);}),
            Instruction("CCF",		    1, 4, {complementFlag(Flag.OVERFLOW);}),
            Instruction("LD B,B",		1, 4, {load(regs.b, regs.b);}),
            Instruction("LD B,C",		1, 4, {load(regs.b, regs.c);}),
            Instruction("LD B,D",		1, 4, {load(regs.b, regs.d);}),
            Instruction("LD B,E",		1, 4, {load(regs.b, regs.e);}),
            Instruction("LD B,H",		1, 4, {load(regs.b, regs.h);}),
            Instruction("LD B,L",		1, 4, {load(regs.b, regs.l);}),
            Instruction("LD B,(HL)",	1, 8, {loadReference(regs.b);}),
            Instruction("LD B,A",		1, 4, {load(regs.b, regs.a);}),
            Instruction("LD C,B",		1, 4, {load(regs.c, regs.b);}),
            Instruction("LD C,C",		1, 4, {load(regs.c, regs.c);}),
            Instruction("LD C,D",		1, 4, {load(regs.c, regs.d);}),
            Instruction("LD C,E",		1, 4, {load(regs.c, regs.e);}),
            Instruction("LD C,H",		1, 4, {load(regs.c, regs.h);}),
            Instruction("LD C,L",		1, 4, {load(regs.c, regs.l);}),
            Instruction("LD C,(HL)",	1, 8, {loadReference(regs.c);}),
            Instruction("LD C,A",		1, 4, {load(regs.c, regs.a);}),
            Instruction("LD D,B",		1, 4, {load(regs.d, regs.b);}),
            Instruction("LD D,C",		1, 4, {load(regs.d, regs.c);}),
            Instruction("LD D,D",		1, 4, {load(regs.d, regs.d);}),
            Instruction("LD D,E",		1, 4, {load(regs.d, regs.e);}),
            Instruction("LD D,H",		1, 4, {load(regs.d, regs.h);}),
            Instruction("LD D,L",		1, 4, {load(regs.d, regs.l);}),
            Instruction("LD D,(HL)",	1, 8, {loadReference(regs.d);}),
            Instruction("LD D,A",		1, 4, {load(regs.d, regs.a);}),
            Instruction("LD E,B",		1, 4, {load(regs.e, regs.b);}),
            Instruction("LD E,C",		1, 4, {load(regs.e, regs.c);}),
            Instruction("LD E,D",		1, 4, {load(regs.e, regs.d);}),
            Instruction("LD E,E",		1, 4, {load(regs.e, regs.e);}),
            Instruction("LD E,H",		1, 4, {load(regs.e, regs.h);}),
            Instruction("LD E,L",		1, 4, {load(regs.e, regs.l);}),
            Instruction("LD E,(HL)",	1, 8, {loadReference(regs.e);}),
            Instruction("LD E,A",		1, 4, {load(regs.e, regs.a);}),
            Instruction("LD H,B",		1, 4, {load(regs.h, regs.b);}),
            Instruction("LD H,C",		1, 4, {load(regs.h, regs.c);}),
            Instruction("LD H,D",		1, 4, {load(regs.h, regs.d);}),
            Instruction("LD H,E",		1, 4, {load(regs.h, regs.e);}),
            Instruction("LD H,H",		1, 4, {load(regs.h, regs.h);}),
            Instruction("LD H,L",		1, 4, {load(regs.h, regs.l);}),
            Instruction("LD H,(HL)",	1, 8, {loadReference(regs.h);}),
            Instruction("LD H,A",		1, 4, {load(regs.h, regs.a);}),
            Instruction("LD L,B",		1, 4, {load(regs.l, regs.b);}),
            Instruction("LD L,C",		1, 4, {load(regs.l, regs.c);}),
            Instruction("LD L,D",		1, 4, {load(regs.l, regs.d);}),
            Instruction("LD L,E",		1, 4, {load(regs.l, regs.e);}),
            Instruction("LD L,H",		1, 4, {load(regs.l, regs.h);}),
            Instruction("LD L,L",		1, 4, {load(regs.l, regs.l);}),
            Instruction("LD L,(HL)",	1, 8, {loadReference(regs.l);}),
            Instruction("LD L,A",		1, 4, {load(regs.l, regs.a);}),
            Instruction("LD (HL),B",	1, 8, {storeInMemory(regs.hl, regs.b);}),
            Instruction("LD (HL),C",	1, 8, {storeInMemory(regs.hl, regs.c);}),
            Instruction("LD (HL),D",	1, 8, {storeInMemory(regs.hl, regs.d);}),
            Instruction("LD (HL),E",	1, 8, {storeInMemory(regs.hl, regs.e);}),
            Instruction("LD (HL),H",	1, 8, {storeInMemory(regs.hl, regs.h);}),
            Instruction("LD (HL),L",	1, 8, {storeInMemory(regs.hl, regs.l);}),
            Instruction("HALT",		    1, 4, null),
            Instruction("LD (HL),A",	1, 8, {storeInMemory(regs.hl, regs.a);}),
            Instruction("LD A,B",		1, 4, {load(regs.a, regs.b);}),
            Instruction("LD A,C",		1, 4, {load(regs.a, regs.c);}),
            Instruction("LD A,D",		1, 4, {load(regs.a, regs.d);}),
            Instruction("LD A,E",		1, 4, {load(regs.a, regs.e);}),
            Instruction("LD A,H",		1, 4, {load(regs.a, regs.h);}),
            Instruction("LD A,L",		1, 4, {load(regs.a, regs.l);}),
            Instruction("LD A,(HL)",	1, 8, {loadReference(regs.a);}),
            Instruction("LD A,A",		1, 4, {load(regs.a, regs.a);}),
            Instruction("ADD A,B",		1, 4, {add(regs.b);}),
            Instruction("ADD A,C",		1, 4, {add(regs.b);}),
            Instruction("ADD A,D",		1, 4, {add(regs.d);}),
            Instruction("ADD A,E",		1, 4, {add(regs.e);}),
            Instruction("ADD A,H",		1, 4, {add(regs.h);}),
            Instruction("ADD A,L",		1, 4, {add(regs.l);}),
            Instruction("ADD A,(HL)",	1, 8, {addReference();}),
            Instruction("ADD A,A",		1, 4, {add(regs.a);}),
            Instruction("ADC A,B",		1, 4, {adc(regs.b);}),
            Instruction("ADC A,C",		1, 4, {adc(regs.c);}),
            Instruction("ADC A,D",		1, 4, {adc(regs.d);}),
            Instruction("ADC A,E",		1, 4, {adc(regs.e);}),
            Instruction("ADC A,H",		1, 4, {adc(regs.h);}),
            Instruction("ADC A,L",		1, 4, {adc(regs.l);}),
            Instruction("ADC A,(HL)",	1, 8, &adcReference),
            Instruction("ADC A,A",		1, 4, {adc(regs.a);}),
            Instruction("SUB B",		1, 4, {sub(regs.b);}),
            Instruction("SUB C",		1, 4, {sub(regs.c);}),
            Instruction("SUB D",		1, 4, {sub(regs.d);}),
            Instruction("SUB E",		1, 4, {sub(regs.e);}),
            Instruction("SUB H",		1, 4, {sub(regs.h);}),
            Instruction("SUB L",		1, 4, {sub(regs.l);}),
            Instruction("SUB (HL)",		1, 8, &subReference),
            Instruction("SUB A",		1, 4, {sub(regs.a);}),
            Instruction("SBC A,B",		1, 4, {sbc(regs.b);}),
            Instruction("SBC A,C",		1, 4, {sbc(regs.c);}),
            Instruction("SBC A,D",		1, 4, {sbc(regs.d);}),
            Instruction("SBC A,E",		1, 4, {sbc(regs.e);}),
            Instruction("SBC A,H",		1, 4, {sbc(regs.h);}),
            Instruction("SBC A,L",		1, 4, {sbc(regs.l);}),
            Instruction("SBC A,(HL)",	1, 8, &sbcReference),
            Instruction("SBC A,A",		1, 4, {sbc(regs.a);}),
            Instruction("AND B",		1, 4, {and(regs.b);}),
            Instruction("AND C",		1, 4, {and(regs.c);}),
            Instruction("AND D",		1, 4, {and(regs.d);}),
            Instruction("AND E",		1, 4, {and(regs.e);}),
            Instruction("AND H",		1, 4, {and(regs.h);}),
            Instruction("AND L",		1, 4, {and(regs.l);}),
            Instruction("AND (HL)",		1, 8, &andReference),
            Instruction("AND A",		1, 4, {and(regs.a);}),
            Instruction("XOR B",		1, 4, {xor(regs.b);}),
            Instruction("XOR C",		1, 4, {xor(regs.c);}),
            Instruction("XOR D",		1, 4, {xor(regs.d);}),
            Instruction("XOR E",		1, 4, {xor(regs.e);}),
            Instruction("XOR H",		1, 4, {xor(regs.h);}),
            Instruction("XOR L",		1, 4, {xor(regs.l);}),
            Instruction("XOR (HL)",		1, 8, &xorReference),
            Instruction("XOR A",		1, 4, {xor(regs.a);}),
            Instruction("OR B",		    1, 4, {or(regs.b);}),
            Instruction("OR C",		    1, 4, {or(regs.c);}),
            Instruction("OR D",		    1, 4, {or(regs.d);}),
            Instruction("OR E",		    1, 4, {or(regs.e);}),
            Instruction("OR H",		    1, 4, {or(regs.h);}),
            Instruction("OR L",		    1, 4, {or(regs.l);}),
            Instruction("OR (HL)",		1, 8, &orReference),
            Instruction("OR A",		    1, 4, {or(regs.a);}),
            Instruction("CP B",		    1, 4, {cp(regs.b);}),
            Instruction("CP C",		    1, 4, {cp(regs.c);}),
            Instruction("CP D",		    1, 4, {cp(regs.d);}),
            Instruction("CP E",		    1, 4, {cp(regs.e);}),
            Instruction("CP H",		    1, 4, {cp(regs.h);}),
            Instruction("CP L",		    1, 4, {cp(regs.l);}),
            Instruction("CP (HL)",		1, 8, &cpReference),
            Instruction("CP A",		    1, 4, {cp(regs.a);}),
            Instruction("RET NZ",		1, 0, {retIfFlag(Flag.ZERO, false);}),
            Instruction("POP BC",		1, 12, {popFromStack(regs.bc);}),
            Instruction("JP NZ,a16",	3, 0, {jumpImmediateIfFlag(Flag.ZERO, false);}),
            Instruction("JP a16",		3, 16, &jumpImmediate),
            Instruction("CALL NZ,a16",	3, 0, {callImmediateIfFlag(Flag.ZERO, false);}),
            Instruction("PUSH BC",		1, 16, {pushToStack(regs.bc);}),
            Instruction("ADD A,d8",		2, 8, &addImmediate),
            Instruction("RST 00H",		1, 16, {rst(0x00);}),
            Instruction("RET Z",		1, 0, {retIfFlag(Flag.ZERO, true);}),
            Instruction("RET",		    1, 16, &ret),
            Instruction("JP Z,a16",		3, 0, {jumpImmediateIfFlag(Flag.ZERO, true);}),
            Instruction("PREFIX CB",	1, 4, null),
            Instruction("CALL Z,a16",	3, 0, {callImmediateIfFlag(Flag.ZERO, true);}),
            Instruction("CALL a16",		3, 24, &callImmediate),
            Instruction("ADC A,d8",		2, 8, &adcImmediate),
            Instruction("RST 08H",		1, 16, {rst(0x08);}),
            Instruction("RET NC",		1, 0, {retIfFlag(Flag.OVERFLOW, false);}),
            Instruction("POP DE",		1, 12, {popFromStack(regs.de);}),
            Instruction("JP NC,a16",	3, 0, {jumpImmediateIfFlag(Flag.OVERFLOW, false);}),
            Instruction("XX",		    0, 0, null),
            Instruction("CALL NC,a16",	3, 0, {callImmediateIfFlag(Flag.OVERFLOW, false);}),
            Instruction("PUSH DE",		1, 16, {pushToStack(regs.de);}),
            Instruction("SUB d8",		2, 8, &subImmediate),
            Instruction("RST 10H",		1, 16, {rst(0x10);}),
            Instruction("RET C",		1, 0, {retIfFlag(Flag.OVERFLOW, true);}),
            Instruction("RETI",		    1, 16, null),
            Instruction("JP C,a16",		3, 0, {jumpImmediateIfFlag(Flag.OVERFLOW, true);}),
            Instruction("XX",		    0, 0, null),
            Instruction("CALL C,a16",	3, 0, {callImmediateIfFlag(Flag.OVERFLOW, true);}),
            Instruction("XX",		    0, 0, null),
            Instruction("SBC A,d8",		2, 8, &sbcImmediate),
            Instruction("RST 18H",		1, 16, {rst(0x18);}),
            Instruction("LDH (a8),A",	2, 12, &ldhAToImmediate),
            Instruction("POP HL",		1, 12, {popFromStack(regs.hl);}),
            Instruction("LD (C),A",		2, 8, &ldCA),
            Instruction("XX",		    0, 0, null),
            Instruction("XX",		    0, 0, null),
            Instruction("PUSH HL",		1, 16, {pushToStack(regs.hl);}),
            Instruction("AND d8",		2, 8, &andImmediate),
            Instruction("RST 20H",		1, 16, {rst(0x20);}),
            Instruction("ADD SP,r8",	2, 16, &offsetStackPointerImmediate),
            Instruction("JP (HL)",		1, 4, &jumpHL),
            Instruction("LD (a16),A",	3, 16, {storeInImmediateReference(regs.a);}),
            Instruction("XX",		    0, 0, null),
            Instruction("XX",		    0, 0, null),
            Instruction("XX",		    0, 0, null),
            Instruction("XOR d8",		2, 8, &xorImmediate),
            Instruction("RST 28H",		1, 16, {rst(0x28);}),
            Instruction("LDH A,(a8)",	2, 12, &ldhImmediateToA),
            Instruction("POP AF",		1, 12, {popFromStack(regs.af);}),
            Instruction("LD A,(C)",		2, 8, &ldAC),
            Instruction("DI",		    1, 4, null),
            Instruction("XX",		    0, 0, null),
            Instruction("PUSH AF",		1, 16, {pushToStack(regs.af);}),
            Instruction("OR d8",		2, 8, &orImmediate),
            Instruction("RST 30H",		1, 16, {rst(0x30);}),
            Instruction("LD HL,SP+r8",	2, 12, &loadSPplusImmediateToHL),
            Instruction("LD SP,HL",		1, 8, {load(regs.sp, regs.hl);}),
            Instruction("LD A,(a16)",	3, 16, {loadFromImmediateReference(regs.a);}),
            Instruction("EI",		    1, 4, null),
            Instruction("XX",		    0, 0, null),
            Instruction("XX",		    0, 0, null),
            Instruction("CP d8",		2, 8, &cpImmediate),
            Instruction("RST 38H",		1, 16, {rst(0x38);}),
        ];
